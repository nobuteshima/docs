...
| ---------------------------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| wk display formula as symbol | displayFormulaAsSymbol | Muestra las referencias de las fórmulas como un símbolo ![](/assets/en/WritePro/commands/pict6013182.en.png). Sólo funciona si las fórmulas se muestran como referencias (ver wk visible references). Valores posibles: True/False                                                                                                                                                                                                                                  |
