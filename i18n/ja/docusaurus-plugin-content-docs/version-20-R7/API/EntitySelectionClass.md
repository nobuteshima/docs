...
| options       | 整数     |              ->             | `dk diacritical`, `dk count values` |
...
| 引数  | 型      |                             | 説明                   |
| --- | ------ | :-------------------------: | -------------------- |
| 属性  | テキスト   |              ->             | 取得したいパスを持つオブジェクト属性名  |
| 戻り値 | コレクション | <- | 重複しないパスを格納した新規コレクション |
...
| 引数  | 型    |                             | 説明                                                      |
| --- | ---- | --------------------------- | ------------------------------------------------------- |
| 戻り値 | テキスト | <- | エンティティセレクションにリンクされたコンテキスト属性 (カンマ区切り) |
...
| keepOrder       | 整数                                 |              ->             | 結果のエンティティセレクションにおいて元の順列を維持するには `dk keep ordered` (整数) を渡します |
