...
| Nom         | Type de données | Valeurs possibles                                                                                                                                                  |
| ----------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| controlType | string          | * **colonnes numériques**: "automatique" (par défaut) ou "case à cocher"
...
[Colonne de list box](listbox_overview.md#list-box-columns) - [Pied de List Box](listbox_overview.md#list-box-footers)
