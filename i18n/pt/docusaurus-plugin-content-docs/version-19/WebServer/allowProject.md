...
As etiquetas 4D tais como `4DEVAL`, `4DTEXT`, `4DHTML`... assim como [`/4DACTION URL`](httpRequests.md#/4daction) permitem-lhe desencadear a execução de qualquer método de um projeto 4D publicado na Web. Por exemplo, a solicitação *<http://www.server.com/4DACTION/login>* causa a execução do método projeto ***login***, se ele existir.
