...
| ---------------------------- | ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| wk display formula as symbol | displayFormulaAsSymbol | Mostra as referências das fórmulas como um símbolo ![](/assets/en/WritePro/commands/pict6013182.en.png). Só funciona se as fórmulas forem mostradas como referências (ver wk visible references). Valores possiveis: True/False                                                                                                                                                                                               |
