...
Uma determinada biblioteca de objetos só pode ser aberta por um banco de dados de cada vez. No entanto, várias bibliotecas diferentes podem ser abertas no mesmo banco de dados.
